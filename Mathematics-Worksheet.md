...
## **8. Money, Time, and Calendar**  
131. What is the **total amount** of ₹10 + ₹50 + ₹100 + ₹20?  
132. Ria buys a pen for ₹22.50 and a notebook for ₹35.75. How much does she spend in total?  
133. If you have ₹250 and spend ₹175, how much is left?  
134. Convert **₹3.75** into **paise**.  
135. What is **₹125 ÷ 5**?  
136. Convert **645 minutes** into **hours and minutes**.  
137. How many **minutes** are there in **5 hours**?  
138. A clock shows **10:15 AM**. What will be the time **2 hours 30 minutes later**?  
139. Convert **9:45 PM** into **24-hour format**.  
140. A train leaves at **8:30 AM** and reaches at **2:45 PM**. How long is the journey?  
141. How many **days** are there in **4 weeks**?  
142. If today is **Wednesday**, what day will it be in **10 days**?  
143. How many **months** have **31 days**?  
144. A movie starts at **3:50 PM** and ends at **6:25 PM**. What is the total duration?  
145. How many days are there in a **leap year**?  
146. Convert **2 years 6 months** into **months**.  
147. If March 2 is a Monday, what day will March 9 be?  
148. How many **weeks** are there in **365 days**?  
149. Write the **number of days** in February in a leap year.  
150. How many **hours** are in **3 days**?  
 
## **9. Perimeter and Area**  
151. Find the **perimeter** of a **square** with side **6 cm**.  
152. A rectangle has **length 10 cm** and **breadth 4 cm**. Find its **perimeter**.  
153. What is the **area** of a **square** with side **9 cm**?  
154. The perimeter of a rectangle is **30 cm**. If the **length is 8 cm**, find the breadth.  
155. A **triangle** has sides of **5 cm, 6 cm, and 7 cm**. Find its **perimeter**.  
156. A square has **side length 12 cm**. Find its **area**.  
157. What is the **area** of a rectangle with **length 15 cm** and **breadth 5 cm**?  
158. The **perimeter** of a square is **36 cm**. What is the length of one side?  
159. Find the **area** of a **rectangle** with **length 8 cm** and **breadth 3 cm**.  
160. A **garden** is **7 m long and 5 m wide**. What is its **area**?  
161. What is the **perimeter** of a rectangle with **length 20 cm** and **breadth 15 cm**?  
162. Find the **area** of a **square** with side **14 cm**.  
63. If a **rectangle has an area of 40 cm²** and **length of 8 cm**, find the **breadth**.  
164. A field is **50 m long** and **30 m wide**. What is its **area**?  
165. A carpet is **5 m long** and **2 m wide**. Find the **area**.  
166. The **area** of a **square** is **144 cm²**. Find the **side length**.  
167. A fence encloses a rectangular park **60 m by 40 m**. What is its **perimeter**?  
168. Find the area of a rectangle with **length 9 cm** and **breadth 4 cm**.  
169. The **perimeter** of a square is **48 cm**. Find its **side length**.  
170. A wall is **15 m long and 6 m high**. Find its **area**.  
171. The area of a **rectangular hall** is **90 m²**. If its length is **10 m**, find the **breadth**.  
172. Find the **perimeter** of a rectangle with **length 22 cm** and **breadth 13 cm**.  
173. A square has a side of **11 cm**. Find its **area**.  
174. Find the **area** of a **square** with **side 25 cm**.  
175. A park is **100 m by 50 m**. Find its **perimeter**.  
 
## **10. Symmetry and Patterns**  
176. How many **lines of symmetry** does a **circle** have?  
177. Draw a **line of symmetry** in a rectangle. How many does it have?  
178. Which alphabet letter has **one** line of symmetry? (A, B, or X?)  
179. Identify a shape with **no** lines of symmetry.  
180. Complete the pattern: **2, 4, 8, 16, __?__**  
181. What is the next shape in this pattern: ▲, ▲■, ▲■▲, ▲■▲■, __?__  
182. Draw a symmetrical figure for the letter **M**.  
183. Find a **shape** that is symmetrical but **not a polygon**.  
184. What is the next number in **3, 6, 9, 12, __?__**  
185. Identify a real-life object with **radial symmetry**.  
